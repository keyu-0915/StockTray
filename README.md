...
| **中登** | 机器人、商业航天、游戏、创新医药 | 主题轮动、事件驱动、高弹性 |
...
市场风格的板块定义、采样权重、数量门槛、刷新周期与离线兜底成分支持签名热更新；新定义只在交易日竞价最终阶段切换，失败时继续使用最后有效版本。维护方式见 [市场风格样本热更新](docs/MARKET-DEFINITION.md)。
...
- [完整版本记录](RELEASES.md)
- [v0.2.20 发布说明](docs/RELEASE-v0.2.20.md)
